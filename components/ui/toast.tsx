  ...
  return (
    <ToastPrimitive.Viewport
      ...
      className={cn(
        ...
        isLeft ? 'sm:right-auto sm:left-4' : 'sm:right-4 sm:left-auto',
        className,
      )}
      {...props}
    />
...
function Toast({
  ...
  return (
    <ToastPrimitive.Root
      ...
      className={cn(
        'rounded-2xl group/toast pointer-events-auto absolute z-[calc(1000-var(--toast-index))] w-full border bg-popover text-popover-foreground shadow-lg will-change-transform outline-none select-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50',
